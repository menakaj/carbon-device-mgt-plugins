...
package org.wso2.carbon.iot.geo.dashboard.api.util;

/**
 * This hold the constants related to the device type.
 */
public class Constants {
    public final static String DEFAULT_PERMISSION_RESOURCE = "/permission/admin/device-mgt/geolocationTracker/user";
    public final static String DEFAULT_ROLE_NAME = "geolocationTracker_user";
    ...
    public static final String GEO_LOCATION_TRACKER_HTTPS_EP = "GEO_LOCATION_TRACKER_HTTPS_EP";
    public static final String GEO_LOCATION_TRACKER_HTTP_EP = "GEO_LOCATION_TRACKER_HTTP_EP";
    public static final String GEO_LOCATION_TRACKER_MQTT_EP = "GEO_LOCATION_TRACKER_MQTT_EP";
