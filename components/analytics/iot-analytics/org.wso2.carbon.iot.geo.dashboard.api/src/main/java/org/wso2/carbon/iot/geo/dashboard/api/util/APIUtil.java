...
import org.wso2.carbon.iot.geo.dashboard.api.dto.SensorRecord;
...
public class APIUtil {
    ...
    public static String getDASEndpoint(){
        return "https://localhost:9445";
    }
    ...
    public static Map<String, SensorRecord> createSensorData(List<Record> records) {
        ...
        for (Record record : records) {
            SensorRecord sensorData = createSensorData1(record);
     ...
     */
    public static SensorRecord createSensorData1(Record record) {
